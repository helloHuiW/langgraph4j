var e=globalThis,t={},s={},a=e.parcelRequire0031;null==a&&((a=function(e){if(e in t)return t[e].exports;if(e in s){var a=s[e];delete s[e];var i={id:e,exports:{}};return t[e]=i,a.call(i.exports,i,i.exports),i.exports}var d=Error("Cannot find module '"+e+"'");throw d.code="MODULE_NOT_FOUND",d}).register=function(e,t){s[e]=t},e.parcelRequire0031=a),a.register;var i=a("hNeh9"),d=a("800sp");class l{items;constructor(e=[]){this.items=e}push(e){return this.items.unshift(e)}pop(){return this.items.shift()}peek(){return this.items[0]}get elements(){return this.items}isEmpty(){return 0===this.items.length}get size(){return this.items.length}clear(){this.items=[]}}var r=a("8uVid");const n=(0,r.debug)({on:!0,topic:"LG4JResult"});(0,r.debug)({on:!1,topic:"LG4JResult"});class o extends d.LitElement{static styles=[i.default,(0,d.css)`
  ...
  </div>   `}}window.customElements.define("lg4j-result",o);
//# sourceMappingURL=webui.6d198d54.js.map
