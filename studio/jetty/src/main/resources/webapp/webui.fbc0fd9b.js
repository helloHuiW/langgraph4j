var t=globalThis,e={},a={},s=t.parcelRequire0031;null==s&&((s=function(t){if(t in e)return e[t].exports;if(t in a){var s=a[t];delete a[t];var i={id:t,exports:{}};return e[t]=i,s.call(i.exports,i,i.exports),i.exports}var r=Error("Cannot find module '"+t+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(t,e){a[t]=e},t.parcelRequire0031=s),s.register;var i=s("hNeh9"),r=s("800sp");const n=(0,s("8uVid").debug)({on:!0,topic:"LG4JExecutor"});async function*l(t){let e=t.body?.getReader(),a=new TextDecoder,s="";for(;e;){let{done:t,value:i}=await e.read();if(t)break;try{s+=a.decode(i);let t=JSON.parse(s);s="",yield t}catch(t){console.warn("JSON parse error:",t)}}}class o extends r.LitElement{static styles=[i.default,(0,r.css)`
  ...
  `];static properties={url:{type:String,reflect:!0},test:{type:Boolean,reflect:!0},_executing:{state:!0}};url=null;#t;#e=null;#a;constructor(){super(),this.test=!1,this.formMetaData=[],this._executing=!1}#s(){this._executing=!0,this.dispatchEvent(new CustomEvent("state-updated",{detail:"start",bubbles:!0,composed:!0,cancelable:!0}))}#i(t){if(this._executing=!1,!t)return;if(t instanceof Error)return void this.dispatchEvent(new CustomEvent("state-updated",{detail:"error",bubbles:!0,composed:!0,cancelable:!0}));let[e,{node:a}]=t;this.dispatchEvent(new CustomEvent("state-updated",{detail:"__END__"!==a?"interrupted":"stop",bubbles:!0,composed:!0,cancelable:!0}))}#r(t){n("thread-updated",t.detail),this.#t=t.detail,this.#e=null,this.requestUpdate()}#n(t){n("onNodeUpdated",t),this.#e=t.detail,this.requestUpdate()}connectedCallback(){super.connectedCallback(),this.addEventListener("thread-updated",this.#r),this.addEventListener("node-updated",this.#n),this.#l()}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("thread-updated",this.#r),this.removeEventListener("node-updated",this.#n)}render(){return(0,r.html)`
        <div class="container">
          ...
          <div class="commands">
            <button id="submit" ?disabled=${this._executing} @click="${this.#o}" class="btn btn-primary item1">Submit</button>
            <button id="resume" ?disabled=${!this.#e||this._executing} @click="${this.#d}" class="btn btn-secondary item2">
            Resume ${this.#e?"(from "+this.#e?.node+")":""}
            </button>
            <button id="cancel" @click="${this.#c}" ?disabled=${!this._executing} class="btn btn-error item3 text-white" aria-label="Stop">
              Cancel
        ...
        `}#u(t){let e=this.shadowRoot?.getElementById("error_dialog");if(e&&"showModal"in e){let a=e.querySelector("#error_message");a&&(a.textContent=t),e.showModal()}}async #l(){let t=await fetch(`${this.url}/init${window.location.search}`,{method:"GET",credentials:"include"});if(!t.ok)return this.#u(t.statusText),null;let e=await t.json();n("initData",e),this.dispatchEvent(new CustomEvent("init",{detail:e,bubbles:!0,composed:!0,cancelable:!0})),this.#a=e.id,this.formMetaData=e.args,this.requestUpdate()}async #d(){this.#s();let t=null;try{t=await this.#h()}catch(e){e instanceof Error&&(this.#u(e.message),t=e)}finally{this.#i(t)}}async #h(){let t=await fetch(`${this.url}/stream/${this.#a}?thread=${this.#t}&resume=true&node=${this.#e?.node}&checkpoint=${this.#e?.checkpoint}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(this.#e?.data)});if(!t.ok)throw Error(t.statusText);this.#e=null;let e=null;for await(let a of l(t))n(a),e=a,this.dispatchEvent(new CustomEvent("result",{detail:a,bubbles:!0,composed:!0,cancelable:!0}));return e}async #o(){this.#s();let t=null;try{t=await this.#p()}catch(e){e instanceof Error&&(this.#u(e.message),t=e)}finally{this.#i(t)}}async #c(){if(!this._executing)return;let t=await fetch(`${this.url}/stream/${this.#a}?thread=${this.#t}&cancel=true`,{method:"DELETE"});if(!t.ok)throw Error(t.statusText);let e=new CustomEvent("result",{detail:[this.#t,{cancelled:!0}],bubbles:!0,composed:!0,cancelable:!0});this.dispatchEvent(e)}async #p(){let t=this.formMetaData.reduce((t,e)=>{let{name:a,type:s}=e,i=this.shadowRoot?.getElementById(a);switch(s){case"STRING":case"IMAGE":t[a]=i?.value}return t},{}),e=await fetch(`${this.url}/stream/${this.#a}?thread=${this.#t}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!e.ok)throw Error(e.statusText);let a=null;for await(let t of l(e)){n("SUBMIT RESULT",t),a=t;let e=new CustomEvent("result",{detail:t,bubbles:!0,composed:!0,cancelable:!0});this.dispatchEvent(e)}return a}}window.customElements.define("lg4j-executor",o);
